...
After cloning the repository switch to the ```task3_crud_api``` branch.
...
Start testing (server must be running in development or production mode):

```bash
npm run test
```

Start the server in development mode with clustering:
